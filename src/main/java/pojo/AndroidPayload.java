...
public class AndroidPayload {
	...
	public AndroidPayload(AndroidPolicy androidPolicy, String reactivateWebSecurityMinutes, int highlightActiveControl,
			int logLevel, String name, String android_ruleOrder, String active, String undefined, String pac_url,
			String android_onnet_filter, String androidlogMode, int logFileSize, String description, int ruleOrder,
			int logMode, String forwardingProfileId, int groupAll, List<String> groups, int device_type) {
